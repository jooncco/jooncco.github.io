---
title: "코드포스 1475D. Cleaning the Phone"
...
<cite><b>[Codeforces Round #697(Div.3) D](http://codeforces.com/problemset/problem/1475/D)</b></cite>
<br/>
...
<div>
    <ul>
        ...
        <li>따라서, \(sum1 = 0, sum2 = \sum a_{b_i=2}\)에서 시작해서 prefix를 점점 늘려가면, \(sum2\)는 감소할일 밖에 없으므로 \(O(n)\) 안에 전체 탐색 가능.</li>
    </ul>
    <br/>
