...
[Problem](http://codeforces.com/problemset/problem/155/C)
...
1. <span class="paragraph_bolster">forbidden pair</span>가 연속된 **substring**(continuous subsequence) 들을 찾고,
2. 그 각각의 substring들에서 삭제해야 하는 최소 letter수(**greedy**)를 더해준다.

<br/>

$$ Complexity: O( k \cdot \lvert s \rvert ) $$


<br/>
<div class="paragraph_header">Solution</div>
<div><img src="/assets/images/codeforces-155C-result.png"/></div>
