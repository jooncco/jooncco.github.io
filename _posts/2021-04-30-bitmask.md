...
> <span class="paragraph_bolster">15 퍼즐</span>
...
여전히 4비트를 낭비하고 있고,  
결정적으로 이렇게 해서는 **이 <span class="paragraph_bolster">상태</span>를 인덱스로 쓸수가 없다.**

<br/>

4비트 x 16개 = 64.  
정답은 <span class="paragraph_bolster">uint64_t</span> 타입의 bitmask다.
