...
### 🎈<span class="bolster">Model</span>: data와 data를 처리하는 부분  
...
단점들을 보완한 디자인 패턴들이 당연히 나왔고, 다음 포스팅에서 다뤄볼 예정이다.  
